...
class _PostScreenState extends State<PostScreen> {
  ...
  getCurency() {
    FirebaseFirestore.instance
      ...
      print("krmanjjjjjjjjjjjjjjjjjjjjj");
      print(temp['euro']);
                                                                  ...
                                                                  children: [
                                                                    InkWell(
                                                                      onTap:
                                                                        ...
                                                                        productsSell[index]['price'] =
                                                                            double.parse(_priceController.text);
                                                                        productsSell[index]
                                                                            [
                                                                            'priceI'] = productsSell[index]
                                                                                ['price'] *
                                                                            curency;
                                                                        calclutateTotal();
                                                                      },
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                            ...
                                                                            hintText:
                                                                                'Enter Number',
                                                                            hintStyle:
                                                                                TextStyle(color: Color.fromRGBO(235, 118, 189, 1), fontSize: 14),
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Text(
                                                                              ...
                                                                              style: TextStyle(color: Color.fromRGBO(235, 118, 189, 1)),
                                                                            ),
                                                                            Text(
                                                                              productsSell[index]['price'].toString() + "  Lb   -   " + productsSell[index]['priceI'].toString() + "  IQD" + "  -  Qt " + productsSell[index]['quantity'].toString(),
                                                                              style: TextStyle(color: Color.fromRGBO(235, 118, 189, 1)),
                                                                            ),
                                                                            Text(
                                                                  ...
                                                                  children: [
                                                                    RotatedBox(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          "Quantity",
                                                                          style:
                                                                              TextStyle(color: Color.fromRGBO(235, 118, 189, 1)),
                                                                        )),
                                                                    Container(
                                                                      width:
                                                                          width *
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            NumberPicker(
                                                                          textStyle:
                                                                              TextStyle(color: Color.fromRGBO(235, 118, 189, 0.7)),
